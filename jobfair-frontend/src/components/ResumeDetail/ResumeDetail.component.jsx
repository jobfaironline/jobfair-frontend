...
import {Anchor, Card, Col, Collapse, Descriptions, Layout, Row, Space, Tooltip, Typography} from "antd";
import {Content} from "antd/es/layout/layout";
import {convertEnumToString, convertToDateString, handleProgress} from "../../utils/common";
import {
  CalendarOutlined,
  GlobalOutlined,
  HomeOutlined,
  MailOutlined, ManOutlined,
  PhoneOutlined,
  TeamOutlined, WomanOutlined
...
const ResumeDetailComponent = (props) => {
  const {onFinish, form, handleOnChangeDob, data, role} = props
          ...
          <Card
            ...
            <div style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', marginLeft: '5rem'}}>
                ...
                {role === 'COMPANY_MANAGER' || role === 'COMPANY_EMPLOYEE' ? (
