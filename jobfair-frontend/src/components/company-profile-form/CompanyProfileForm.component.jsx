...
const CompanyProfileForm = ({urlValue, noStyle, data, editable}) => {
    ...
    return (
        <>
            ...
            >
                {noStyle ? <Text>{data.companyDescription}</Text> :  <TextArea showCount maxLength={3000} placeholder="Company description" style={{width: 300}}/>}
            </Form.Item>
            <div className="site-input-group-wrapper">
                ...
                >
                    <Input.Group compact>
                        ...
                        >
                            {noStyle ? <Text>{data.url}</Text> :   <Input
                                ...
                                return (
                                    <div key={key} style={{display: 'flex', flexDirection: 'row'}}>
                                        ...
                                        <Form.Item
                                            ...
                                            label="Description"
                                            rules={editable ?
                                                CompanyProfileValidation.description : []}
                                            style={{width: 400}}
                                        >
