...
import {Button, Divider, Input, Space, Spin, Table, Typography} from "antd";
import SearchOutlined from "@ant-design/icons/SearchOutlined";
import Highlighter from "react-highlight-words";
import JobPositionTableColumn from "../../JobPositionTable/JobPositionTable.column";

const JobPositionManagementComponent = ({data, extra}) => {
    ...
    return (
        ...
        <Divider>
            ...
            <Table columns={finalColumns} dataSource={data} pagination={false}/>
        </>
