export const PATH = {
  INDEX: '/',
  JOB_FAIR_PARK_PAGE: '/map/:jobFairId',
  ATTENDANT_JOB_FAIR_PAGE: '/jobfair/attendant/:companyBoothId',
  ATTENDANT_JOB_FAIR_PATH: '/jobfair/attendant/',
  JOB_FAIR_REGISTRATION_PAGE_ID: '/company-register-jobfair/:jobfairId',
  ...
  JOB_FAIRS_PAGE: '/jobfair-list',
  JOB_FAIR_LIST_PAGE: '/job-fair',
