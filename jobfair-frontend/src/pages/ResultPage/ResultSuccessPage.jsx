    ...
    <div className="page">
      ...
      >
        <div className="desc">
          ...
          <Paragraph>
            In the meantime, you can check the <Link to={PATH.FAQ_PAGE}>FAQ Section</Link> or <Link to={PATH.PUBLICIZED_JOB_FAIR_PAGE}>Job Fair Page</Link> to check other job fairs !
          </Paragraph>
