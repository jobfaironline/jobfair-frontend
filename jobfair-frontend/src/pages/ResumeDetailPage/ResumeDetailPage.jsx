  ...
  return (
    <div className="page">
      <PageHeader
        ...
        onBack={() => history.push('/company/applied-job')}
                        ...
                        <Row gutter={[16, 16]}>
                          ...
                          <Col span={12} key="skill_proficiency">
                            <Space>
                              ...
                              <Text>{handleProgress(item.proficiency)}</Text>
                            </Space>
                          </Col>
                        </Row>
                      </Panel>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '5rem' }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Text strong>{data.account?.email}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                    ...
                    >
                      <Text strong>{data.account?.phone}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                    ...
                    >
                      <Text strong>{CountryConst.find(item => item.id === data?.countryId)?.name}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                        <Tooltip title="Country">
                    ...
                    >
                      <Text strong>{convertToDateString(data.dob)}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                    ...
                    <Descriptions.Item
                      label={
                        <Tooltip title="Job title">
                          <TeamOutlined /> Job title
                        </Tooltip>
                      }
                    >
                      <Text strong>{data?.jobTitle}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                        <Tooltip title="Job level">
                          <TeamOutlined /> Job level
                        </Tooltip>
                      }
                    >
                      <Text strong>{convertEnumToString(data?.jobLevel)}</Text>
                    </Descriptions.Item>
                    <Descriptions.Item
                      label={
                        <Tooltip title="Year of experience">
                          <TeamOutlined /> Year of experience
                        </Tooltip>
                      }
                    >
                      <Text strong>{data?.yearOfExp} year(s)</Text>
                    </Descriptions.Item>
                  </Descriptions>
                  ,
                </Card>
