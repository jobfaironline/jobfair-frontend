      ...
      <Collapse defaultActiveKey={['1']} ghost={true}>
        ...
        <Panel header={
          ...
          <Paragraph style={{margin: '0 2rem'}}>
            ...
            All orders with a shipping destination outside Switzerland or the Principality of Liechtenstein are charged
            without value added tax (VAT). Depending on the country, taxes and/or import fees may apply during the
            import, which are levied by the national post office or the courier company. Taxes and/or import fees may
            vary from country to country and must be paid by the buyer.
          </Paragraph>
        </Panel>
        <Panel header={
          <div style={{fontSize: 'large'}}>
