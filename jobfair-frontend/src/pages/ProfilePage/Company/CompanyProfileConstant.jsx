...
export const SubCategories = [
  ...
  {
    value: 24,
    label: 'Pharmaceutical representatives',
    category_id: 4
  },
  {
    value: 25,
  ...
  {
    value: 38,
    label: 'Merchandising/Purchasing/Supply chain',
    category_id: 8
  },
  {
    value: 39,
...
export const benefitDescriptionsConst = [
  {
    value:
      'e.g: $200 a month kindergarten allowance per child under 5 years old'
  },
  {
    value: 'e.g: Lunch and unlimited snacks'
  },
  {
    value: 'e.g: Premium healthcare plan for you and your family'
  },
  {
    value: 'e.g: Monthly award for the excellent employees of the month'
  },
  {
    value: 'e.g: 13th payment'
  },
  {
    value:
      'e.g: $200 a month kindergarten allowance per child under 5 years old'
...
export const benefitConst = [
  ...
  },
  {
    value: 5,
    label: 'Laptop',
    description: 'e.g: New Macbook Pro for all employees'
  },
  {
    value: 6,
    label: 'Team Activities',
    description: 'e.g: Innovation time-off events all throughout the year'
  },
  {
    value: 7,
    label: 'Others',
    description: 'e.g: Lovers guaranteed...'
  },
  {
    value: 8,
    label: 'Library',
    description:
      'e.g: Unlimited access to online library with more than 20,000 ebooks'
  },
  {
    value: 9,
    label: 'Paid Leave',
    description: 'e.g: 20 days full paid leave a year'
  },
  {
    value: 10,
    label: 'Travel Opportunities',
    description: 'e.g: 2-3 trips a year to work in headquarters'
  },
  {
    value: 11,
    label: 'Transportation',
    description: 'e.g: Company van provided to all employees'
  },
  {
    value: 12,
    label: 'Mobile',
    description:
      'e.g: New Iphone 12 for each employee with $20 allowance a month'
  },
  {
    value: 13,
    label: 'Vouchers',
    description: 'e.g: $100 vouchers to spend in more than 100 shops'
  },
  {
    value: 14,
    label: 'Training',
