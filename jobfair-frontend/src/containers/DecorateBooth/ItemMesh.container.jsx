...
import {calculateMeshDimensionRange, calculateMeshSize, calculatePositionWithBoundary} from "../../utils/ThreeJS/threeJSUtil";
...
export const ItemMeshContainer = (props) => {
    ...
    const itemMeshProps = {position, onClick, onPointerOver, onPointerLeave, useDragBind, mesh };
